...
<cu-custom bgColor="bg-gradual-blue" :isBack="true">
			...
			<block slot="content">智慧停车系统介绍</block>
		</cu-custom>
	...
	<view class="titleZ text-center align-center">
		...
		<view class="contentZ">
			<text class="text-xl">小程序具有即开即用，免注册登陆等特点，非常适合用户使用的场景。用户可以在小程序上浏览最新停车公告，快速缴费，查询附近停车位，并且导航到停车路段，能查询自己的停车记录，缴费记录等等停车信息。</text>
		</view>
	</view>
