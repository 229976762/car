<template>
	<view>
		...
		<news v-if="PageCur=='news'" :newsList="newsList"></news>
		...
		<view class="box">
			<view class="cu-bar tabbar bg-white shadow foot">
				...
				<view class="action" @click="NavChange" data-cur="search">
					...
					<view :class="PageCur=='search'?'color_main':'text-gray'">缴费详情</view>
				</view>
				...
				<view class="action" @click="NavChange" data-cur="news">
					...
					<view :class="PageCur=='news'?'color_main':'text-gray'">系统公告</view>
				</view>
			...
			getData() {
				...
				request.httpTokenRequest(opts).then(res => {
					...
					if (res.statusCode == 200) {
						...
						that.message = that.newsList.length
					}
				});
			},
			ShowNews(e){
